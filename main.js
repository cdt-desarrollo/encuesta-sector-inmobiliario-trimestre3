...
function sendData(array) {
    ...
    var config = {
      method: "post",
      url: "https://sheet.best/api/sheets/32aacf91-902e-4e88-8d70-e596b2f41ceb/tabs/trim32023",
      mode: "cors",
      headers: {
  ...
  Swal.fire({
    ...
    preConfirm: () => {
      ...
      if(ciudad == ""){
        ...
        if (inputObject.id == "otrostrim3q11") {
          document.getElementById("insertCitytrim3q11").innerHTML = "";
          document.getElementById("otrostrim3q11").value = ciudad;
  ...
  Swal.fire({
    ...
    preConfirm: () => {
      ...
      if(uso == ""){
        ...
        if(inputObject.id == "otrostrim3q15"){
          document.getElementById("insertUsetrim3q15").innerHTML = "";
          document.getElementById("otrostrim3q15").value = uso;
          document.getElementById(
            "insertUsetrim3q15"
